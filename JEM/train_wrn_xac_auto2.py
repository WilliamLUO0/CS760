...
for epoch in range(n_epochs):
    ...
    for i, batch_data_p in tqdm(enumerate(dload_train)):
        ...
        if p_x_weight > 0:  # max log p(x)
            ...
            if cur_iter % print_every ==0:
                ...
                # print("Lp(x):{}".format(p_x_weight * l_p_x))
        ...
        if p_a_given_x_weight > 0:  # max log(a|x)
            ...
            if cur_iter % print_every == 0:
                ...
                # print("Lp(a|x):{}".format(p_a_given_x_weight * l_p_a_given_x))
        ...
        if p_c_given_x_a_weight > 0:  # max log(c|x,a)
            ...
            if cur_iter % print_every == 0:
                ...
                # print("Lp(c|a,x):{}".format(p_c_given_x_a_weight * l_p_c_given_x_a))
    ...
    if epoch % eval_every == 0:
        ...
        with t.no_grad():
            ...
            correct_a_train, correct_c_train, loss_train = eval_classification(f, dload_train)
            print("Epoch {}: Train Loss {}, Train Attribute Acc {}, Train Category Acc {}".format(epoch, loss_train, correct_a_train, correct_c_train))
